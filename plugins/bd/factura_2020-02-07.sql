...
# Tiempo de Generación: 2020-02-07 14:07:36 +0000
# ************************************************************
...
INSERT INTO `docs` (`id`, `ruc`, `razon`, `direccion`, `serie`, `fecha_emision`, `tipo`, `numero`, `total`, `estado`, `sunat`, `cliente_id`, `venta_interna`)
VALUES
	(11,'','','','','1970-01-01','','',NULL,1,NULL,NULL,'3');
